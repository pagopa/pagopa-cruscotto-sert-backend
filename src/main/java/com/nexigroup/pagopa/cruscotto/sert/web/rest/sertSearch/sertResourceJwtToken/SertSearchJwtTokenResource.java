...
public class SertSearchJwtTokenResource extends SertResource {

    private final Logger log = LoggerFactory.getLogger(SertSearchJwtTokenResource.class);

    public SertSearchJwtTokenResource(SertService sertService) {
        super(sertService);
    }
